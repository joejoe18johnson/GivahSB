  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-white dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto prose prose-lg text-gray-700 dark:text-gray-300">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">1. Who we are</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">2. Data we collect</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">3. How we use your data</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">4. Legal basis</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">5. Sharing your data</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">6. Data security</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">7. Your rights under Belize law</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">8. Data deletion requests</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">9. Retention</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">9. Children</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">11. Changes to this notice</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">12. Contact us</h2>
            <p>
