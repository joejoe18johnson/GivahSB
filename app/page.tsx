        ...
        <div className="flex-1 container mx-auto px-4 py-8 md:py-12 flex flex-col justify-center">
          ...
          <div className="order-2 lg:order-1 flex flex-col justify-center mt-14 sm:mt-16 lg:mt-0 min-h-[320px] lg:min-h-[400px] animate-fade-in-up opacity-0 [animation-fill-mode:forwards]">
            <div className="mb-4 w-full max-w-xl md:max-w-none md:w-max pb-1 flex justify-center md:justify-start">
              <h1 className="font-bold text-gray-900 whitespace-normal md:whitespace-nowrap min-w-0 md:min-w-max w-full md:w-auto text-center md:text-left text-[clamp(1.1rem,(100vw - 2rem) / 15,2.5rem)] md:text-4xl lg:text-5xl xl:text-6xl pb-[0.2em]">
