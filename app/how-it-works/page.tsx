        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/campaigns"
                className="relative gradient-outline-btn border-2 border-primary-600 text-primary-600 px-8 py-4 rounded-full font-medium hover:bg-primary-50 transition-colors text-lg dark:border-transparent dark:bg-transparent dark:text-gray-900 dark:hover:bg-gray-200"
              >
                Explore Campaigns
              </Link>
            </div>
