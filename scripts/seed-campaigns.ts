...
function campaign(
  ...
  return {
    ...
    image: opts.image ?? `https://picsum.photos/seed/givah${n}/800/600`,
...
const DEMO_CAMPAIGNS = [
  ...
  campaign(11, { title: "Scholarship Fund for Toledo Students", description: "Scholarships for 20 secondary students in Toledo.", fullDescription: "We provide scholarships for secondary school students in Toledo whose families cannot afford fees and supplies. Your support keeps students in school.", creator: "Toledo Education Trust", creatorType: "charity", category: "Education", location: "Toledo District, Belize", goal: 4000, raised: 1850, backers: 56, daysLeft: 14, image: "/scholarship-toledo-1.png", image2: "/scholarship-toledo-2.png" }),
  campaign(12, { title: "Flood Relief in Belmopan", description: "Emergency supplies for families displaced by flooding.", fullDescription: "Recent flooding in Belmopan displaced dozens of families. We are providing food, water, shelter, and cleaning supplies. All donations go directly to affected households.", creator: "Belmopan Relief Fund", creatorType: "organization", category: "Emergency", location: "Belmopan, Belize", goal: 5500, raised: 2900, backers: 89, daysLeft: 10, image: "/flooding-belize-1.png", image2: "/flooding-belize-2.png" }),
  ...
  campaign(16, { title: "Cancer Treatment for Ana", description: "Help cover chemotherapy and travel for Ana's cancer treatment.", fullDescription: "Ana was diagnosed with cancer and needs chemotherapy. Treatment is in Belize City; she lives in the district. Funds will cover treatment costs and travel for her and a caregiver.", creator: "Ana's Support Circle", creatorType: "individual", category: "Medical", location: "Caye Caulker, Belize", goal: 7500, raised: 3200, backers: 72, daysLeft: 12, image: "/cancer-treatment-ana-1.png", image2: "/cancer-treatment-ana-2.png" }),
  ...
  campaign(31, { title: "Hip Replacement for Mrs. Garcia", description: "Surgery and rehab for an elderly woman who cannot walk.", fullDescription: "Mrs. Garcia needs a hip replacement to walk again without pain. She has waited years. Her family has saved what they can; we are raising the rest for surgery and rehabilitation.", creator: "Garcia Family", creatorType: "individual", category: "Medical", location: "San Ignacio, Cayo District, Belize", goal: 7000, raised: 3100, backers: 78, daysLeft: 7, image: "/hip-replacement-mrs-garcia-1.png", image2: "/hip-replacement-mrs-garcia-2.png" }),
