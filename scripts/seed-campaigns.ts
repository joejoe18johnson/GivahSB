...
const CATEGORIES = ["Medical", "Education", "Disaster Relief", "Community", "Emergency", "Other"] as const;
...
const DEMO_CAMPAIGNS = [
  ...
  campaign(12, { title: "Flood Relief in Belmopan", description: "Emergency supplies for families displaced by flooding.", fullDescription: "Recent flooding in Belmopan displaced dozens of families. We are providing food, water, shelter, and cleaning supplies. All donations go directly to affected households.", creator: "Belmopan Relief Fund", creatorType: "organization", category: "Disaster Relief", location: "Belmopan, Belize", goal: 5500, raised: 2900, backers: 89, daysLeft: 10 }),
  ...
  campaign(21, { title: "Hurricane Shelter Supplies", description: "Stock a community hurricane shelter with food and first aid.", fullDescription: "Our community hurricane shelter needs to be stocked before the next season: non-perishable food, water, first aid kits, and basic hygiene supplies. Your donation prepares us to help neighbors in need.", creator: "Dangriga Shelter Committee", creatorType: "organization", category: "Disaster Relief", location: "Dangriga, Belize", goal: 3800, raised: 1550, backers: 44, daysLeft: 11 }),
  ...
  campaign(28, { title: "Flood Recovery in Southern Belize", description: "Clean-up and repair for families after severe flooding.", fullDescription: "Severe flooding in southern Belize damaged homes and crops. Families need help with clean-up, minor repairs, and replacement of lost items. We distribute funds and supplies directly to affected households.", creator: "Southern Belize Flood Relief", creatorType: "organization", category: "Disaster Relief", location: "Toledo District, Belize", goal: 5000, raised: 2400, backers: 67, daysLeft: 9 }),
